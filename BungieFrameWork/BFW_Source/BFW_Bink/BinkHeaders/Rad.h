...
//  __RADMAC__ means Macintosh (Pre OS X, or OS X with CW)
//  __RADMACOSX__ means Mac OS X (Mach-O, ProjectBuilder, gcc)
...
#if (!defined(__RADDOS__) && !defined(__RADWIN__) && !defined(__RADMAC__) && !defined(__RADMACOSX__))
